...
<body>
	<div class = "container">
		<div id = "header">
		<br/>
				<img src = "images/lIB IMAGEE.PNG" style = " margin-top:-17px; float:left; margin-left:115px; margin-bottom:-6px; width:100px; height:100px;">
				<img src = "images/LIB IMAHE.PNG" style = " margin-top:-17px; float:right; margin-right:115px; width:100px; height:100px;" >
